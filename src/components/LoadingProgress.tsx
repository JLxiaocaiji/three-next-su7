...
export default function LoadingProgress() {
  ...
  const offsets = [
    ...
    interpolate(loadingProgress, 0, 100, 0.009828499911662297, 0.5278),
    interpolate(loadingProgress, 0, 100, 0.012767601859784745, 0.7698),
    interpolate(loadingProgress, 0, 100, 0.012767601859784745, 1.0),
  ];
  ...
  return (
    ...
    >
      ...
      <div className="progress-num text-white text-xl mt-6">{loadingProgress}%</div>
    </aside>
  );
}
